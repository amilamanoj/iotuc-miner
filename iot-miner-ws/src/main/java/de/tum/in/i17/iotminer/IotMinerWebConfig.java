...
@EnableWebMvc
@EnableSwagger2
public class IotMinerWebConfig extends WebMvcConfigurerAdapter {
    ...
    public Docket apiConfiguration() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("de.tum.in.i17.iotminer"))
                .build();
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("IoT Use-Case Miner REST Web Services API")
